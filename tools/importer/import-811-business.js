...
const PAGE_TEMPLATE = {
  name: '811-business',
  description: 'Kotak811 Business Account landing page: alternating hero banners and benefit card grids.',
  urls: [
    'http://localhost:3000/drafts/811-business.plain.html',
  ],
  blocks: [
...
export default {
  transform: (payload) => {
    ...
    // 6. force the output path to /811-business (source is a drafts/*.plain.html file)
    const path = WebImporter.FileUtils.sanitizePath('/811-business');
